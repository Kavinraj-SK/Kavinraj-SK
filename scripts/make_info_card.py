...
# ===========================================================================
HOST = "kavinraj"   # shown as  kavinraj@github  in the header
...
ROWS = [
    ...
    ("kv", "Frontend", "React, Tailwind CSS, HTML/CSS"),
    ("kv", "Backend", "Node.js, Express, MySQL"),
    ("kv", "Tools", "Git, GitHub, Linux, AWS"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Text-to-SQL: NL-to-SQL engine w/ live schema + context"),
    ("bul", "RemoteDesk: WebRTC P2P remote desktop, AWS-integrated"),
    ("bul", "QueryWeaver: NL to SQL/Mongo/Redis via Groq AI"),
]
